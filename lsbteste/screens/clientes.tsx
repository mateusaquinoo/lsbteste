...
import imageSource from "../../assets/iconeAlunos.png" 
...
export default function Clientes() {
  ...
  const handleSelectStudent = (student: any) => {
    ...
    setSearchQuery(student.label); // Update search query to selected student
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.box}>
        ...
        <View>
          <Text style={styles.titleBox}>Alunos</Text>
          <Text style={styles.subTitleBox}>5 ano - A</Text>
        </View>
      </View>
      ...
      >
        <Ionicons name="search" size={20} color="#3C83ED" style={styles.searchIcon} />
        <TextInput
...
const styles = StyleSheet.create({
    header: {
        ...
        padding: 10,
        borderBottomWidth: 1,
        borderBottomColor: 'blue', // Cor da borda inferior do cabeçalho
      },
      headerExpanded: {
        borderBottomWidth: 0, // Remove a borda inferior quando expandido
      },
      headerText: {
        fontSize: 16,
        color: '#333',
      ...
      content: {
        padding: 10,
        backgroundColor: '#fff',
        borderBottomWidth: 1, // Adiciona a borda inferior ao conteúdo expandido
        borderBottomColor: 'blue', // Cor da borda inferior do conteúdo
      },
